            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a href="{{ route('data-lembur-d') }}" class="nav-link">
                    <i class="fas fa-database"></i>
                       <p> Data Lembur D atasan empat</p>
                </a>
              </li>
             @endif
             ...
             <li class="nav-item">
                <a href="{{ route('data-lembur-g') }}" class="nav-link">
                   <i class="fas fa-database"></i>
                       <p> Data Lembur G atasan tujuh </p>
                </a>
              </li>
             @endif
             ...
             <li class="nav-item">
                <a href="{{ route('data-lembur-h') }}" class="nav-link">
                   <i class="fas fa-database"></i>
                       <p> Data Lembur H atasan delapan </p>
                </a>
              </li>
             @endif
